AA:= URLDownloadToVar("https://raw.githubusercontent.com/Guestman2/RoN_Automizer/main/README.md")
msgbox % AA
...
URLDownloadToVar(url) {
 ...
 if InStr(text, "Version1" ;Change "Pinda" to a new word after you are going to push a update change your txt file to text="YourWord"
{
